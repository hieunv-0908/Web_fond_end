...
const theTichHinhCau = (4 / 3) * pi * Math.pow(r, 3);
document.write("<br></br> Thể tích hình cầu: " + theTichHinhCau.toFixed(2));

const dienTichBeMat = 4 * pi * Math.pow(r, 2);
document.write("<br></br> Diện tích bề mặt: " + dienTichBeMat.toFixed(2));

const chuViLonNhat = 2 * pi * r;
document.write("<br></br> Chu vi lớn nhất của hình cầu: " + chuViLonNhat.toFixed(2));