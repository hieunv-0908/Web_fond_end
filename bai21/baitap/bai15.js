var menhGia = [500000, 200000, 100000, 50000, 20000, 10000, 5000, 2000, 1000]; // Danh sách các mệnh giá
...
if (soTien % 1000 !== 0 || isNaN(soTien) || soTien <= 0) {
    ...
    for (var i = 0; i < menhGia.length; i++) {
        var soTo = Math.floor(soTien / menhGia[i]); // Số tờ của mệnh giá hiện tại
        if (soTo > 0) {
